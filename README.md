...
4. images/
This directory is for storing any relevant images, such as ER diagrams, schema designs, or screenshots of query results.
You can add visuals to enhance the documentation and understanding of the project.
Key Features
